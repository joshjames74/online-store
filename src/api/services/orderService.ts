...
import { getEntitiesByFields, getOneEntityByField } from "../helpers/dynamicQuery";
import { OrderParams, orderQueryTransformer } from "../transformers/orderSearchTransformer";
...
export async function getOrderViewsBySearch(params: OrderParams): Promise<OrderView | void> {
    const { whereQuery, orderQuery } = queryParamsToPrismaQuery(params, orderQueryTransformer);
