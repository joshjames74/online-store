...
import { getReviewsByProductId, getReviewsBySearch } from "@/api/services/reviewService";
...
export async function GET(req: NextRequest, { params }:  { params: { id: string } }): Promise<NextResponse> {
    ...
    const reviewParams: Partial<ReviewParams> = { review_filter, score, productId: parseInt(id) };  
