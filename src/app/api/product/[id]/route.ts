...
import { deleteProductById, getProductById, putProductByFields } from '@/api/services/productService';
...
export async function PUT(req: NextRequest, { params }: { params: { id: string }}): Promise<NextResponse> {
    ...
    const searchField: FieldValuePair<'product'> = { field: 'id', value: parseInt(id) };
