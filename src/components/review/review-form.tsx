"use client";
import { Box, Button, FormControl, FormLabel, Input, Text, Textarea, useToast, UseToastOptions } from "@chakra-ui/react";
...
export default function ReviewForm(): JSX.Element {
    ...
    const defaultReview = { usrId: 1, productId: 11, image_urls: '' }
