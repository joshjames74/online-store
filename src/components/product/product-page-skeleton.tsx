import { Box, Card, CardBody, CardHeader, Divider, Heading, HStack, Image, Skeleton, SkeletonText, Stack, Text } from "@chakra-ui/react";
    ...
    return (
        ...
        <HStack h="fit-content" alignItems="stretch">
            ...
            <Card h="300px" alignSelf="stretch" minW="sm" paddingX="1em">
                <CardHeader><Heading fontSize="md" fontWeight="semibold">Add to basket</Heading></CardHeader>
                <CardBody h="200px">
                    <Stack h="full" >
